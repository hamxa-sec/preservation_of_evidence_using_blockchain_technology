...
const teamMembers = [
  { name: "Ali Zulqarnain", role: 'Founder & Develpor', bio: 'Blockchain Backend Develpor' },
  { name: 'Hamza Qasim', role: 'Developer', bio: 'Expert in smart contract development.' },
  { name: 'Mahjbeen', role: 'Researcher', bio: 'Data Collection For creation' },
];
    ...
    <Box position="relative" minH="100vh" bg="white" color={themeConfig.text}>
      ...
      >
        <VStack gap={12} align="stretch" maxW="1200px" mx="auto">
          ...
          >
            <Text fontSize="xl" textAlign="center" maxW="800px" mx="auto" color="whiteAlpha.900">
              Evidia is a decentralized platform leveraging blockchain and IPFS to provide secure, transparent file sharing and storage solutions.
            </Text>
          </MotionBox>
          ...
          >
            <Heading size="xl" fontFamily="'Poppins', sans-serif" color={themeConfig.primary} textAlign="center">
              Our Team
            </Heading>
          </MotionBox>
